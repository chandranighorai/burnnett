class ProductbycategoryDets {
  String status;
  String message;
  List<Productdata> productdata;

  ProductbycategoryDets({this.status, this.message, this.productdata});

  ProductbycategoryDets.fromJson(Map<String, dynamic> json) {
    status = json['status'];
